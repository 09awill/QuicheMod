...
namespace Quiche.Customs.Quiche
{
    ...
    {
        public override string UniqueNameID => "Cheese Tomato Quiche";
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("CheeseTomatoQuiche").AssignMaterialsByNames();
        public override ItemCategory ItemCategory => ItemCategory.Generic;
        public override ItemValue ItemValue => ItemValue.Medium;
        public override Item SplitSubItem => Mod.CheeseTomatoQuicheSlice;
        public override int SplitCount => 3;
        public override float SplitSpeed => 1f;
        public override List<Item> SplitDepletedItems => new List<Item>() { Mod.CheeseTomatoQuicheSlice };
        public override string ColourBlindTag => "CT";
